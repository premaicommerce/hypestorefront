    ...
    <footer className="border-t border-gray-100 bg-white">
      <div className="mx-auto max-w-7xl px-6 py-12 grid gap-10 md:grid-cols-4">
        <div className="md:col-span-2">
          <div className="text-lg font-semibold text-ink">Dev Prints</div>
          ...
          <p className="mt-4 text-sm text-muted">
            Support: <a className="text-brand-700 hover:underline" href="mailto:support@test.com">support@test.com</a>
          </p>
        </div>
      ...
      <div className="border-t border-gray-100">
        <div className="mx-auto max-w-7xl px-6 py-6 text-xs text-muted flex flex-col md:flex-row gap-2 md:items-center md:justify-between">
          <span>© {new Date().getFullYear()} Dev Prints. All rights reserved.</span>
